...
export function LanguageSwitcher() {
  ...
  return (
    <m.button
      ...
      className="fixed top-2 right-14 sm:top-4 sm:right-20 z-50 p-2 sm:p-3 rounded-full bg-white dark:bg-gray-900 shadow-lg border border-gray-200 dark:border-gray-800 hover:border-work-400 dark:hover:border-work-600 transition-colors"
